    ...
    <section className="flex justify-center items-center h-screen">
      <div className="flex justify-center items-center flex-nowrap w-full max-w-[1200px] banner-width p-5">
        ...
        <div
          ...
          "
        >
          <h4 className="text-xl font-medium text-[#000000]">Welcome to Competence </h4>
          <div className="my-4">
            ...
            <form onSubmit={handleLogin} className="mt-7">
              ...
              <input
                ...
                className={`border border-solid ${isEmailInvalid ? "border-red-500" : "border-[#DDD9D9]"
                  } p-2 text-sm rounded-lg w-full mt-2 mb-4 pr-10 focus:ring focus:outline-none focus:ring-[#000000] focus:border-[#000000]`}
              />
              ...
              <div className="relative">
                <input
                  ...
                  className={`border border-solid focus:ring focus:outline-none focus:ring-[#000000] focus:border-[#000000] ${isPasswordInvalid ? "border-red-500" : "border-[#DDD9D9]"
              ...
              <div className="flex justify-between items-center">
                ...
                <Link href="/forgot-password">
                  <p className="text-[#000000] text-sm hover:text-[#00000099] transition-all cursor-pointer">
                    Forgot Password?
                  </p>
                </Link>
              </div>
              <button
                type="submit"
                className={`${loading ? "bg-[#00000099] cursor-not-allowed" : "bg-[#000000] cursor-pointer scale-105 transition-all duration-300"} rounded-xl px-4 py-3 w-full mt-8 text-white transition-all font-medium`}
                disabled={loading}
              >
