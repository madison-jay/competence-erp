            ...
            <div className="mb-9">
                <div className="flex flex-wrap gap-4 items-center justify-between">
                    ...
                    <div className="flex flex-wrap gap-4 items-center">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <select
                                ...
                                className="border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#000000]"
                            >
                        ...
                        <div className="relative min-w-[200px]">
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#000000]"
                            />
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 bg-[#000000] text-white px-4 py-2 rounded-lg font-medium hover:bg-[#9a7516] transition-all shadow-sm hover:shadow-md"
                    >
