                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
                        ...
                        <select
                            ...
                            className="mt-1 block w-full rounded-md border-[#e8e8e8] border border-solid shadow-sm focus:border-[#000000] focus:ring-1 focus:ring-[#000000] px-3 py-3 focus:ring-opacity-50"
                        >
                                ...
                                {transactions.map((transaction, index) => (
                                    <tr key={index} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 transition-all">
                                            <button onClick={() => handleViewMore(transaction)} className="text-[#000000] hover:text-[#775a12]">
                    ...
                    <div className="mt-4 flex justify-between items-center">
                        <div className="flex items-center">
                            ...
                            <select
                                ...
                                className="rounded-md border-[#e8e8e8] border border-solid shadow-sm focus:border-[#000000] focus:ring-1 focus:ring-[#000000] p-2 focus:ring-opacity-50"
                            >
            ...
            {selectedDetails && (
                <div className="fixed inset-0 bg-[#000000aa] flex items-center justify-center z-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg max-w-lg w-full overflow-y-auto max-h-[80vh]">
                        ...
                        <button
                            className="bg-[#000000] transition-all float-right text-white px-4 py-2 rounded hover:bg-[#977215]"
