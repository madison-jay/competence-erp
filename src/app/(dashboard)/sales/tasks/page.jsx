        ...
        return (
            <div className="relative rounded-md shadow-sm w-full max-w-sm">
                ...
                <input
                    ...
                    name="search"
                    id="search"
                    className="block w-full rounded-md border-0 py-1.5 pl-10 pr-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#000000] sm:text-sm sm:leading-6"
            ...
            <div className="flex items-center justify-between p-4 md:p-6 bg-white border-b border-gray-200">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <button
                        ...
                        className="whitespace-nowrap px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#000000] hover:bg-[#a67c18] outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#000000]"
                    >
                        Add new task
                    </button>
                </div>
