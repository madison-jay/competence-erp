        ...
        const fetchEmployees = async () => {
            try {
                ...
                const salesEmployees = allEmployees.filter(
                    emp => 
                        emp.departments?.name.toLowerCase() === 'sales' &&
    ...
    return (
        <div>
            <div className='flex justify-between items-center mt-5 mb-14 flex-wrap gap-4'>
                <div>
                    <h1 className='text-2xl font-bold'>Active Sales Employees</h1>
            ...
            <div className="mb-7 flex justify-end">
                <input
                    ...
                    className="w-full max-w-md px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#000000]"
                />
            </div>
                        ...
                        {loading ? (
                            ...
                            <tr>
                                <td colSpan="8" className="px-6 py-4 text-center text-sm text-gray-500">
                                    No active sales employees found.
                                </td>
                            </tr>
                        )}
                    </tbody>
                ...
                <div className="flex justify-between items-center mt-7">
                    ...
                    <div className="flex gap-2">
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg ${currentPage === 1 ? 'bg-gray-200 cursor-not-allowed' : 'bg-[#000000] text-white hover:bg-[#8a7412]'}`}
                        >
                            Previous
                        </button>
                        {Array.from({ length: totalPages }, (_, i) => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg ${currentPage === i + 1 ? 'bg-[#000000] text-white' : 'bg-gray-200 hover:bg-gray-300'}`}
                            >
                                {i + 1}
                            </button>
                        ))}
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg ${currentPage === totalPages ? 'bg-gray-200 cursor-not-allowed' : 'bg-[#000000] text-white hover:bg-[#8a7412]'}`}
                        >
                            Next
                        </button>
                    </div>
