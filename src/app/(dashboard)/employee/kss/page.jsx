                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-4 flex-1 min-w-0">
                              <span className="font-bold text-[#000000] text-sm min-w-[40px]">
                                {modIdx + 1}.{i + 1}
                              </span>
                              <div className="flex-1 min-w-0">
                                ...
                                {les.youtube_link && (
                                  <a
                                    ...
                                    className="mt-2 inline-flex items-center text-xs text-[#000000] font-medium hover:underline"
                                  >
              ...
              return (
                <div key={q.id} className="p-4 bg-gray-50 rounded-lg">
                  <p className="font-medium mb-3">
                    <span className="text-[#000000] font-bold">Q{i + 1}.</span> {q.question_text}
                  </p>
