          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#000000]"
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
              />
            </div>
            <button
              className="flex items-center gap-2 bg-[#000000] text-white px-4 py-2 rounded-md hover:bg-[#8d6b14] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
