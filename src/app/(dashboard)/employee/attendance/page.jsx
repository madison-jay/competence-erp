      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            <button
              onClick={prevMonth}
              className="w-8 h-8 flex items-center justify-center rounded-lg bg-gray-200 text-gray-600 hover:bg-[#000000] hover:text-white"
            >
        ...
        <div className="flex items-center space-x-3">
          <div className="relative">
            <input
              ...
              className="py-2 px-4 pl-10 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#000000]"
            />
          ...
          <button
            ...
            disabled={loading}
            className="bg-[#000000] text-white px-4 py-2 rounded-lg font-semibold flex items-center gap-2 hover:bg-[#916e17] disabled:opacity-50"
          >
