          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-10 mt-5">
            <div className="flex items-center space-x-4">
              {employee?.avatar_url ? (
                ...
                <div className="w-12 h-12 bg-[#000000] rounded-full flex items-center justify-center text-white font-bold">
                    ...
                    {isSubmitted ? (
                      <div className="bg-gray-50 p-4 rounded-md space-y-3 text-sm">
                        ...
                        <div>
                          ...
                          <p className="mt-1">
                            {ass.evidence_url ? (
                              <a href={ass.evidence_url} target="_blank" rel="noopener noreferrer" className="text-[#000000] hover:underline">
                                View File
                              </a>
                            ) : (
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          {kpi.target_type === 'boolean' ? (
                            <select
                              ...
                              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#000000] focus:border-[#000000]"
                            >
                        ...
                        <div>
                          ...
                          <div className="space-y-2">
                            <input
                              ...
                              className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#000000] file:text-white hover:file:bg-[#a07a17]"
                            />
                        ...
                        <button
                          ...
                          className="w-full py-2 px-4 bg-[#000000] text-white font-medium rounded-md hover:bg-[#a07a17] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                        >
