...
export default function ShiftPage() {
    ...
    const renderSearchBar = () => (
        <div className="relative rounded-md shadow-sm w-full max-w-sm">
            ...
            <input type="text" className="block w-full rounded-md border-0 py-1.5 pl-10 pr-3 text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-[#000000] sm:text-sm sm:leading-6 focus:border-0"
            ...
            <div className="flex flex-col md:flex-row items-center justify-between p-4 md:p-6 bg-white border-b border-gray-200 rounded-t-lg">
                ...
                <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 w-full md:w-auto">
                    ...
                    <button onClick={()=>{ setEmployeeToUpdateShift({employee:{id:null,name:'',email:'',avatar_url:''},originalScheduleData:null}); setIsAssignShiftModalOpen(true); }}
                            className="whitespace-nowrap px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#000000] hover:bg-[#a67c18] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#000000] w-full md:w-auto">
                        Assign Shift
                    </button>
