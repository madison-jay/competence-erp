    ...
    return (
      <div className="mt-8">
        <div className="flex justify-between items-center mb-4">
          <button onClick={() => handleMonthChange(-1)} className="px-4 py-2 bg-gray-200 rounded-md hover:bg-[#000000] hover:text-white transition-all">
            Prev
          </button>
    ...
    <div className="relative">
      ...
      <div className="flex justify-end mb-6 space-x-2">
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium transition-colors ${displayMode === 'table' ? 'bg-[#000000] text-white shadow' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
        >
          Table View
        </button>
        <button
          onClick={() => setDisplayMode('calendar')}
          className={`px-4 py-2 rounded-lg font-medium transition-colors ${displayMode === 'calendar' ? 'bg-[#000000] text-white shadow' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
        >
          Calendar View
        </button>
      </div>
      ...
      <div className="mb-8 flex flex-col sm:flex-row justify-end gap-4">
        <button onClick={handleOpenSyncModal} className="px-6 py-3 bg-[#000000] text-white font-semibold rounded-lg hover:bg-[#a07917] transition-all shadow-md">
          Sync Attendance
        </button>
        <button
        ...
        <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 w-full sm:w-auto gap-3">
          <div className="relative w-full sm:w-64">
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#000000]"
              value={searchTerm}
          ...
          {displayMode === 'table' && (
            <select
              ...
              className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#000000]"
            >
          ...
          <div className="bg-white p-8 rounded-xl shadow-2xl max-w-md w-full">
            ...
            <div className="flex justify-end space-x-3 mt-8">
              ...
              <button
                ...
                className="px-6 py-2 bg-[#000000] text-white rounded-lg hover:bg-[#a07917] disabled:opacity-70"
              >
        ...
        <div className="fixed inset-0 bg-[#000000aa] bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <input
              ...
              className="w-full px-4 py-2 mb-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#000000]"
            />
