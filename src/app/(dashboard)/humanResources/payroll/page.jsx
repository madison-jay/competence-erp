            ...
            <div className='mb-10 px-5 py-7 bg-[#FDEDC5] text-center rounded-xl'>
                {loading ? (
                    ...
                    <>
                        ...
                        <Link href="/humanResources/payroll/prepare-payroll" className='inline-block mt-4 bg-[#000000] text-white px-6 py-2 rounded-lg hover:bg-[#000000]/90 transition-colors duration-300'>Prepare Payroll</Link>
                    </>
                )}
            </div>
                ...
                <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="relative">
                        <input
                            type="text"
                            placeholder="Search..."
                            className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#000000] focus:border-[#000000]"
                            value={searchTerm}
