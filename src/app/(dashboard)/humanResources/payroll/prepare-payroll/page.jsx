        ...
        <div className="max-w-[1400px] mx-auto p-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                    <select
                        className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#000000] w-full sm:w-auto"
                ...
                <div className="w-full lg:w-1/2 xl:w-2/5 bg-white rounded-xl shadow-lg p-6 max-h-[820px] overflow-y-auto">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <button
                            ...
                            className="text-[#000000] font-medium hover:text-[#a37a1a] transition-colors"
                        >
                            Deselect all
                        </button>
                    </div>
                            ...
                            filteredEmployees.map((employee) => {
                                ...
                                return (
                                    ...
                                    >
                                        <input
                                            type="checkbox"
                                            className={`form-checkbox h-5 w-5 text-[#000000] rounded focus:ring-[#000000] mr-3 ${!canPrepare ? 'cursor-not-allowed' : ''}`}
                                        ...
                                        {employee.isReadyForPayroll && canPrepare && (
                                            <span className="px-3 py-1 text-xs font-medium text-[#000000] bg-yellow-100 rounded-full">
                                                Ready
                                            </span>
                                        )}
                                    </div>
                        ...
                        <>
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <button
                                    ...
                                    className={`px-6 py-2 bg-[#000000] text-white font-semibold rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-[#000000] focus:ring-opacity-75 ${selectedEmployee.isReadyForPayroll && selectedEmployee.canPreparePayroll ? 'hover:bg-[#a37a1a]' : 'opacity-50 cursor-not-allowed'}`}
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    {selectedEmployee.canPreparePayroll && (
                                                        <button
                                                            ...
                                                            className="text-gray-400 hover:text-[#000000] opacity-0 group-hover:opacity-100 transition-opacity"
                                                        >
