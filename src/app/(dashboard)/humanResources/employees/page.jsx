        ...
        return pageNumbers.map((number, index) => (
            <button
                ...
                className={`px-4 py-2 rounded-md mx-1 text-sm font-medium transition-colors
                    ${number === currentPage ? 'bg-white border border-solid border-[#000000]' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-6">
                ...
                <div className="flex items-center space-x-4 w-full sm:w-auto flex-wrap gap-4">
                    <div className='flex flex-nowrap gap-2 items-center'>
                        <div className="relative grow">
                            <input
                                type="text"
                                placeholder="Search..."
                                className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-[#000000]"
                                value={searchTerm}
                                onChange={(e) => {
                    ...
                    <button
                        ...
                        className="flex items-center px-4 py-2 bg-[#000000] text-white rounded-lg hover:bg-[#997417] transition-colors shadow-md cursor-pointer"
                    >
            ...
            {sortedAndFilteredEmployees.length > 0 && !loading && (
                <div className="flex justify-center items-center mt-6 space-x-2">
                    <button
                        ...
                        className="px-4 py-2 rounded-md border border-gray-300 text-gray-700 hover:text-white hover:bg-[#000000] transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                    >
                        &lt;
                    </button>
