      ...
      <div className="flex justify-between items-center mb-3 gap-5 flex-wrap">
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            className="px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#000000]"
            disabled={isLoading}
          />
          <button
            onClick={openCreateModal}
            className="px-4 py-2 bg-[#000000] text-white rounded-md hover:bg-[#a07a17] disabled:opacity-50"
            disabled={isLoading}
          >
            Create Template
          </button>
        ...
        <div className="flex justify-center mt-6 gap-2">
          ...
          {[...Array(totalPages)].map((_, i) => (
            <button
              ...
              className={`px-3 py-1 rounded ${currentPage === i + 1 ? 'bg-[#000000] text-white' : 'bg-gray-200'}`}
            >
              {i + 1}
            </button>
          ))}
          ...
          <div className="bg-white p-6 rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input name="title" value={formData.title} onChange={handleFormChange} required className="w-full border rounded border-gray-300 focus:border-[#000000] outline-none focus:outline-[#000000] px-3 py-2" />
              </div>
              <div>
                <label className="block font-medium mb-1">Description</label>
                <textarea name="description" value={formData.description} onChange={handleFormChange} className="w-full border rounded resize-none border-gray-300 focus:border-[#000000] outline-none focus:outline-[#000000] px-3 py-2" rows="3" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block font-medium mb-1">Weight (0–1)</label>
                  <input type="number" name="weight" step="0.01" min="0" max="1" value={formData.weight} onChange={handleFormChange} required className="w-full border rounded border-gray-300 focus:border-[#000000] outline-none focus:outline-[#000000] px-3 py-2" />
                </div>
                <div>
              ...
              <div>
                ...
                <select name="target_type" value={formData.target_type} onChange={handleFormChange} className="w-full border rounded border-gray-300 focus:border-[#000000] outline-none focus:outline-[#000000] px-3 py-2">
              ...
              {formData.target_type === 'range' ? (
                <div className="grid grid-cols-2 gap-4">
                  <input type="number" name="target_min" placeholder="Min" value={formData.target_value.min || ''} onChange={handleFormChange} required className="border rounded border-gray-300 focus:border-[#000000] outline-none focus:outline-[#000000] px-3 py-2" />
                  <input type="number" name="target_max" placeholder="Max" value={formData.target_value.max || ''} onChange={handleFormChange} required className="border rounded border-gray-300 focus:border-[#000000] outline-none focus:outline-[#000000] px-3 py-2" />
                </div>
                ...
                <input
                  ...
                  required
                  className="w-full border rounded px-3 py-2 border-gray-300 focus:border-[#000000] outline-none focus:outline-[#000000]"
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                <button type="submit" disabled={isLoading} className="px-5 py-2 bg-[#000000] text-white rounded hover:bg-[#a07a17] disabled:opacity-50">
