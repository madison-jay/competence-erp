                ...
                <div className="p-6 border-b border-gray-200">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            <div className="w-12 h-12 bg-gradient-to-r from-[#000000] to-[#a67c18] rounded-xl flex items-center justify-center">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    disabled={isSubmitting}
                                    className={`pl-10 w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-[#000000] focus:border-transparent transition-all duration-200 ${
                                        errors.employeeId 
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <select
                                ...
                                disabled={isSubmitting}
                                className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-[#000000] focus:border-transparent transition-all duration-200 ${
                                    errors.shiftTypeId 
                                        ? 'border-red-300 focus:ring-red-500' 
                                        : 'border-gray-200 hover:border-gray-300'
                                }`}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    disabled={isSubmitting}
                                    className={`pl-11 w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-[#000000] focus:border-transparent transition-all duration-200 ${
                                        errors.startDate 
                                            ? 'border-red-300 focus:ring-red-500' 
                                            : 'border-gray-200 hover:border-gray-300'
                                    }`}
                    ...
                    <div className="flex space-x-3 pt-4">
                        ...
                        <button
                            type="submit"
                            disabled={isSubmitting}
                            className="flex-1 px-6 py-3 bg-gradient-to-r from-[#000000] to-[#a67c18] text-white rounded-xl hover:from-[#a67c18] hover:to-[#9b7216] focus:outline-none focus:ring-2 focus:ring-[#000000] font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                        >
                            {isSubmitting ? (
                                <>
