  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Header */}
        <div className="bg-linear-to-r from-[#000000] to-[#d4a53b] text-white p-6 rounded-t-2xl">
          {isLoading ? (
        ...
        <div className="p-6 space-y-6">
          ...
          <section>
            <h3 className="text-lg font-semibold text-gray-800 mb-3 flex items-center">
              <svg className="w-5 h-5 mr-2 text-[#000000]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <section>
            <div className="flex justify-between items-center mb-6 gap-5 flex-wrap">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-[#000000] hover:bg-[#d4a53b] text-white font-medium py-2 px-4 rounded-lg shadow-lg transition transform hover:scale-105"
              >
          ...
          <section>
            <h3 className="text-lg font-semibold text-gray-800 mb-6 flex items-center">
              <FontAwesomeIcon icon={faFileAlt} className="w-5 h-5 mr-2 text-[#000000]" />
              ...
              {rawEmployee.employee_documents && rawEmployee.employee_documents.length > 0 && !isLoading && (
                <div>
                  <h4 className="text-lg font-semibold text-gray-700 mb-4 flex items-center">
                    <FontAwesomeIcon icon={faFolderOpen} className="w-5 h-5 mr-2 text-[#000000]" />
                ...
                <div className="flex gap-16 mt-20 print:mt-0 print:gap-12 w-full justify-center">
                  ...
                  <div className="h-[85mm] w-[50mm] bg-cover bg-center relative" style={{ backgroundImage: 'url("/id-card-01.svg")' }}>
                    ...
                    <div className="absolute translate-x-1/2 -left-1/2 top-32 w-full">
                      <h2 className="text-center font-bold text-xl text-[#000000]">{fullName || "Employee Name"}</h2>
                      <h4 className="text-center text-[14px] font-semibold">{rawEmployee.position || "Position"}</h4>
                      <hr className="w-[80%] text-[#000000] mx-auto h-0.5 mt-2" />
                    </div>
                  ...
                  <div className="h-[85mm] w-[50mm] bg-cover bg-center relative" style={{ backgroundImage: 'url("/id-card-02.svg")' }}>
                    ...
                    <div className="absolute mx-2 top-[94px] w-[96%]">
                      ...
                      <p className="text-[11px] text-gray-700 mt-1"><strong> <FontAwesomeIcon icon={faSquareEnvelope} /> </strong> info@competenceng.com</p>
