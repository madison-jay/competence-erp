                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="md:col-span-2 flex flex-col items-center mb-4">
                            <label htmlFor="avatar" className="block text-sm font-medium text-black mb-2">
                                Employee Photo <span className="text-[#000000]">*</span>
                            </label>
                        ...
                        <div>
                            <label htmlFor="date_of_birth" className="block text-sm font-medium text-black mb-1">
                                Date of Birth <span className="text-[#000000]">*</span>
                            </label>
                            <input
                                type="date"
                                id="date_of_birth"
                        ...
                        <div>
                            <label htmlFor="marital_status" className="block text-sm font-medium text-black mb-1">
                                Marital Status <span className="text-[#000000]">*</span>
                            </label>
                            <select
                                id="marital_status"
                                name="marital_status"
                        ...
                        <div>
                            <label htmlFor="gender" className="block text-sm font-medium text-black mb-1">
                                Gender <span className="text-[#000000]">*</span>
                            </label>
                            <select
                                id="gender"
                                name="gender"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label htmlFor="phone_number" className="block text-sm font-medium text-black mb-1">
                                Phone Number <span className="text-[#000000]">*</span>
                            </label>
                            <input
                                type="tel"
                                id="phone_number"
                        ...
                        <div>
                            <label htmlFor="address" className="block text-sm font-medium text-black mb-1">
                                Address <span className="text-[#000000]">*</span>
                            </label>
                            <input
                                type="text"
                                id="address"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label htmlFor="hire_date" className="block text-sm font-medium text-black mb-1">
                                Hire Date <span className="text-[#000000]">*</span>
                            </label>
                            <input
                                type="date"
                                id="hire_date"
                        ...
                        <div>
                            <label htmlFor="position" className="block text-sm font-medium text-black mb-1">
                                Position <span className="text-[#000000]">*</span>
                            </label>
                            <input
                                id="position"
                                type='text'
                        ...
                        <div>
                            <label htmlFor="department_id" className="block text-sm font-medium text-black mb-1">
                                Department <span className="text-[#000000]">*</span>
                            </label>
                            <select
                                id="department_id"
                                name="department_id"
                        ...
                        <div>
                            <label htmlFor="location_id" className="block text-sm font-medium text-black mb-1">
                                Location <span className="text-[#000000]">*</span>
                            </label>
                            <select
                                id="location_id"
                                name="location_id"
                        ...
                        <div>
                            <label htmlFor="guarantor_name" className="block text-sm font-medium text-black mb-1">
                                Guarantor Name <span className="text-[#000000]">*</span>
                            </label>
                            <input
                                type="text"
                                id="guarantor_name"
                        ...
                        <div>
                            <label htmlFor="guarantor_phone_number" className="block text-sm font-medium text-black mb-1">
                                Guarantor Phone Number <span className="text-[#000000]">*</span>
                            </label>
                            <input
                                type="tel"
                        ...
                        <div>
                            <label htmlFor="guarantor_name_2" className="block text-sm font-medium text-black mb-1">
                                Second Guarantor Name <span className="text-[#000000]">*</span>
                            </label>
                            <input
                                type="text"
                                id="guarantor_name_2"
                        ...
                        <div>
                            <label htmlFor="guarantor_phone_number_2" className="block text-sm font-medium text-black mb-1">
                                Second Guarantor Phone <span className="text-[#000000]">*</span>
                            </label>
                            <input
                                type="tel"
