            ...
            <div className="relative p-6 border w-full max-w-3xl max-h-[90vh] overflow-y-scroll mx-auto rounded-md shadow-lg bg-white"
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label htmlFor="employment_status" className="block text-sm font-medium text-black mb-1">
                                Employment Status <span className="text-[#000000]">*</span>
                            </label>
                            <select
                                ...
                                className="mt-1 block w-full px-3 py-2 border border-black rounded-md shadow-sm focus:outline-none focus:ring-[#000000] focus:border-[#000000] sm:text-sm text-black bg-white"
                            >
                    ...
                    <div className="flex justify-end mt-6">
                        <button
                            type="submit"
                            className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[#000000] hover:bg-[#997417] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#000000] transition-colors duration-200"
                            disabled={loading}
                        >
