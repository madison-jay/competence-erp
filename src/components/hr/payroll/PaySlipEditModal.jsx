    ...
    return (
        <div className="fixed inset-0 bg-[#000000aa] flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl max-h-[90vh] overflow-y-auto shadow-2xl w-full max-w-lg p-8 transform transition-all duration-300 scale-100 opacity-100">
                <h2 className="text-3xl font-extrabold text-gray-900 mb-6 text-center">Edit Payroll for <span className="text-[#000000]">{employee.name}</span></h2>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <input
                                    ...
                                    className="w-36 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#000000] text-right text-lg font-semibold"
                                />
                            </div>
                            <div className="flex items-center justify-between">
                        ...
                        <div className="space-y-3 max-h-60 overflow-y-auto pr-2">
                            <div className="flex items-center justify-between py-2 border-b border-gray-200">
                                <label className="flex items-center flex-grow cursor-pointer">
                                    <input
                                        type="checkbox"
                                        className="form-checkbox h-5 w-5 text-[#000000] rounded focus:ring-[#000000]"
                                ...
                                <input
                                    ...
                                    className="w-24 px-2 py-1 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#000000] text-right text-md"
                                    min="0"
                                />
                ...
                <div className="mt-8 flex justify-end gap-4">
                    ...
                    <button
                        onClick={handleSave}
                        className="px-6 py-2 bg-[#000000] text-white font-semibold rounded-lg shadow-md hover:bg-[#a37a1a] focus:outline-none focus:ring-2 focus:ring-[#000000] focus:ring-opacity-75 transition-all duration-200"
                    >
                        Save Changes
                    </button>
                </div>
