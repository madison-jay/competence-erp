                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            id="instances"
                            name="instances"
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#000000]"
                    ...
                    <div className="mb-4">
                        ...
                        <textarea
                            id="reason"
                            name="reason"
                            className="w-full px-3 py-2 border resize-none border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#000000]"
                    ...
                    <div className="flex justify-end">
                        ...
                        <button
                            type="submit"
                            className={`px-4 py-2 text-white bg-[#000000] rounded-lg font-semibold hover:bg-[#a37a1a] transition-colors
