        ...
        <div className="fixed inset-0 bg-[#000000aa] flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl shadow-2xl max-h-[90vh] overflow-y-auto w-full max-w-lg p-8">
                <h2 className="text-2xl font-extrabold text-gray-900 mb-6 text-center">
                    Confirm Payslip for <span className="text-[#000000]">{employee.name}</span>
                </h2>
                ...
                <div className="mt-8 flex justify-end gap-4">
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="px-6 py-2 bg-[#000000] text-white font-semibold rounded-lg shadow-md hover:bg-[#a37a1a] focus:outline-none focus:ring-2 focus:ring-[#000000] focus:ring-opacity-75 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {isLoading ? (
