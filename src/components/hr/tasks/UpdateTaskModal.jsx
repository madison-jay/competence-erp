        ...
        <div className="space-y-4">
            <div>
                ...
                <input
                    ...
                    className="mt-1 block w-full rounded-md border-gray-300 focus:border-[#000000] focus:ring-[#000000] sm:text-sm p-2 border"
                    required
                />
            </div>
            <div>
                ...
                <textarea
                    ...
                    onChange={handleChange}
                    rows="3"
                    className="mt-1 block w-full rounded-md border-gray-300 resize-none focus:border-[#000000] focus:ring-[#000000] sm:text-sm p-2 border"
                ></textarea>
            </div>
        ...
        <div className="space-y-4">
            <div className="mb-4 relative" ref={dropdownRef}>
                ...
                <div className="relative">
                    <input
                        type="text"
                        className="block w-full rounded-md border border-gray-300 focus:border-[#000000] focus:ring-[#000000] sm:text-sm p-2 pr-10"
        ...
        <div className="space-y-4">
            <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-md p-4 text-center">
                    ...
                    <label
                        htmlFor="file-upload"
                        className="cursor-pointer text-[#000000] hover:text-[#a67c18] font-medium"
                    >
                            ...
                            <div key={index} className="flex items-center justify-between bg-gray-50 rounded-md p-3">
                                ...
                                <div className="flex space-x-2">
                                    <a
                                        ...
                                        className="text-[#000000] hover:text-[#a67c18]"
                                    >
                                        View
                                    </a>
                                    <button
                    ...
                    <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        <button
                            ...
                            className={`w-full inline-flex justify-center rounded-md border border-transparent px-4 py-2 text-base font-medium text-white sm:ml-3 sm:w-auto sm:text-sm
                                ${isSaving ? 'bg-[#000000] cursor-not-allowed' : 'bg-[#000000] hover:bg-[#a67c18] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#000000]'}
                            `}
                            disabled={isSaving}
                        >
                            {isSaving ? (
