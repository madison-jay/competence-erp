            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl p-6 relative max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <p className="text-sm font-medium text-[#000000] mb-1">Task Title:</p>
                            <p className="text-lg text-black font-semibold">{task.title || 'Untitled Task'}</p>
                        </div>

                        <div>
                            <p className="text-sm font-medium text-[#000000] mb-1">Description:</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <p className="text-sm font-medium text-[#000000] mb-1">Start Date:</p>
                            <p className="text-base text-black font-semibold">{formatDate(task.start_date)}</p>
                        </div>
                        <div>
                            <p className="text-sm font-medium text-[#000000] mb-1">Due Date:</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <p className="text-sm font-medium text-[#000000] mb-1">Priority:</p>
                            <p className="text-base text-black font-semibold capitalize">{task.priority || 'Not specified'}</p>
                        </div>

                        <div>
                            <p className="text-sm font-medium text-[#000000] mb-1">Status:</p>
                            {renderBadge(task.status || 'Pending')}
                        </div>
                    </div>

                    <div>
                        <p className="text-sm font-medium text-[#000000] mb-1">Created By:</p>
                    ...
                    {task.task_documents && task.task_documents.length > 0 && (
                        <div>
                            <p className="text-sm font-medium text-[#000000] mb-1">Attachments:</p>
                            <div className="space-y-2">
