                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                id="title"
                                name="title"
                                className="block w-full rounded-md border border-gray-300 shadow-sm focus:border-[#000000] focus:ring-[#000000] sm:text-sm p-2"
                        ...
                        <div className="mb-4 relative" ref={dropdownRef}>
                            ...
                            <div className="relative">
                                <input
                                    type="text"
                                    className="block w-full rounded-md border border-gray-300 shadow-sm focus:border-[#000000] focus:ring-[#000000] sm:text-sm p-2 pr-10"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        id="start_date"
                                        name="start_date"
                                        className="block w-full rounded-md border border-gray-300 shadow-sm focus:border-[#000000] focus:ring-[#000000] sm:text-sm pr-10 p-2"
                            ...
                            >
                                <div className="space-y-1 text-center">
                                    ...
                                    <div className="flex text-sm text-gray-600 justify-center">
                                        <label
                                            htmlFor="file-upload"
                                            className="relative cursor-pointer rounded-md bg-white font-medium text-[#000000] focus-within:outline-none focus-within:ring-2 focus-within:ring-[#000000] focus-within:ring-offset-2 hover:text-[#a67c18]"
                                        >
                        ...
                        <div className="flex justify-end space-x-3">
                            <button
                                type="button"
                                onClick={onClose}
                                className="inline-flex justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#000000] focus:ring-offset-2"
                                disabled={isSubmitting}
                            >
                                Cancel
                            </button>
                            <button
                                type="submit"
                                className="inline-flex justify-center rounded-md border border-transparent bg-[#000000] px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-[#a67c18] focus:outline-none focus:ring-2 focus:ring-[#000000] focus:ring-offset-2"
                                disabled={isSubmitting}
                            >
