        ...
        <div className="fixed inset-0 bg-[#000000aa] bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-sm w-full mx-4">
                <div className="flex justify-center items-center">
                    <FontAwesomeIcon icon={faSpinner} spin size="2x" className="text-[#000000]" />
        ...
        <div className="fixed inset-0 bg-[#000000aa] bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full mx-4">
                <div className="text-center">
                    ...
                    <button
                        onClick={onClose}
                        className="px-4 py-2 bg-[#000000] text-white rounded-md hover:bg-[#8b6a15] transition-colors"
                    >
                        Close
                    </button>
                </div>
        ...
        <>
            ...
            <div className="fixed inset-0 bg-[#000000aa] bg-opacity-50 flex justify-center items-center z-50 p-4">
                <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                    {/* Header - unchanged */}
                    <div className="bg-gradient-to-r from-[#000000] to-[#d4af37] p-6 rounded-t-lg">
                    ...
                    <div className="p-6">
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                            <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                                <FontAwesomeIcon icon={faUser} className="text-[#000000] mr-2" />
                                Customer Information
                            </h3>
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                            <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                                <FontAwesomeIcon icon={faBox} className="text-[#000000] mr-2" />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-white border border-gray-200 rounded-lg p-6">
                                <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                                    <FontAwesomeIcon icon={faMapMarkerAlt} className="text-[#000000] mr-2" />
                                    Delivery Information
                                </h3>
                            ...
                            <div className="bg-white border border-gray-200 rounded-lg p-6">
                                <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                                    <FontAwesomeIcon icon={faStickyNote} className="text-[#000000] mr-2" />
                                    Additional Information
                                </h3>
                                <div className="space-y-3">
                                    <div>
                        ...
                        <div className="flex justify-end space-x-3 mt-6 pt-6 border-t border-gray-200">
                            ...
                            <button
                                onClick={handlePrint}
                                className="px-6 py-2 bg-[#000000] text-white rounded-md hover:bg-[#8b6a15] transition-colors flex items-center"
                            >
