...
const CreateOrderModal = ({ isOpen, onClose, onSubmit }) => {
    ...
    const [accountName] = useState("Competence Ltd");
        ...
        <div style="font-family: Arial, sans-serif; padding: 30px; background: white; color: #333; max-width: 100%;">
            ...
            <div style="display: flex; justify-content: space-between; margin-bottom: 30px; flex-wrap: wrap; gap: 20px;">
                <div style="flex: 1; min-width: 250px; min-height: 180px;">
                    <div style="background: #000000; color: white; padding: 10px 15px; border-radius: 5px 5px 0 0;">
                ...
                <div style="flex: 1; min-width: 200px; min-height: 180px;">
                    <div style="background: #000000; color: white; padding: 10px 15px; border-radius: 5px 5px 0 0; text-align: center;">
                    ...
                    <div style="border: 1px solid #ddd; border-top: none; padding: 15px; border-radius: 0 0 5px 5px; text-align: center; height: calc(100% - 42px); display: flex; align-items: center; justify-content: center;">
                        <p style="font-size: 24px; font-weight: bold; color: #000000; margin: 0;">₦${orderData.total_amount.toLocaleString()}</p>
                    </div>
                </div>
            </div>
            ...
            <div style="display: flex; justify-content: space-between; margin-bottom: 30px; flex-wrap: wrap; gap: 20px;">
                ...
                <div style="flex: 1; min-width: 250px; min-height: 200px;">
                    ...
                    <div style="border: 1px solid #ddd; border-top: none; padding: 15px; border-radius: 0 0 5px 5px; height: calc(100% - 42px);">
                        ...
                        ` : ''}
                        ${additionalHtml}
                        <hr style="border: none; border-top: 2px solid #000000; margin: 15px 0;">
                        <div style="display: flex; justify-content: space-between; margin: 10px 0; font-size: 18px; font-weight: bold;">
                            <span>GRAND TOTAL:</span>
                            <span style="color: #000000;">₦${orderData.total_amount.toLocaleString()}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div style="border-top: 3px solid #000000; padding-top: 20px; margin-top: 30px;">
                <div style="text-align: center; margin-bottom: 20px;">
                    <p style="font-size: 18px; font-weight: bold; color: #000000; margin: 0;">Thank you for your patronage!</p>
                </div>
                ...
                <div style="text-align: center; margin-top: 40px; padding: 20px; background: #f5f5f5; border-radius: 5px;">
                    <p style="margin: 5px 0; font-weight: bold; color: #000000;">Competence LIMITED</p>
                    <p style="margin: 3px 0; font-size: 12px;">13, Alhaij Kanike Close, off Awolowo Road, Ikoyi - Lagos</p>
                    <p style="margin: 3px 0; font-size: 12px;">Phone: +234-816-254-7995 | Email: sales@competenceng.com</p>
                    <p style="margin: 3px 0; font-size: 12px;">Website: www.competenceng.com</p>
                </div>
            </div>
        </div>
        `;
        ...
        <div className="fixed inset-0 bg-[#000000aa] flex items-center justify-center z-50 overflow-y-auto">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto m-4">
                <div className="flex justify-between items-center p-6 border-b">
                    <h2 className="text-xl font-bold text-[#000000]">Create Order - Step {currentStep}/2</h2>
                ...
                <form onSubmit={submitOrder} className="p-6">
                    {loadingData ? (
                        <div className="text-center py-12">
                            <FontAwesomeIcon icon={faSpinner} spin className="text-4xl text-[#000000]" />
                        </div>
                    ) : (
                        <>
                                ...
                                <div className="space-y-5">
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#000000] outline-none"
                                        />
                                    ...
                                    {selectedCustomer && (
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input value={selectedCustomer.email || ""} readOnly className="w-full p-3 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#000000] outline-none" />
                                            </div>
                                            <div>
                                                <label className="block font-semibold">Phone</label>
                                                <input value={selectedCustomer.phone || ""} readOnly className="w-full p-3 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#000000] outline-none" />
                                            </div>
                                        </div>
                                    )}
                            ...
                            {currentStep === 2 && (
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#000000] outline-none"
                                        />
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-3 gap-3 mb-3">
                                        <input
                                            ...
                                            className="p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#000000] outline-none"
                                        />
                                        <input
                                            type="number"
                                            value={newCostPrice}
                                        ...
                                        <button
                                            ...
                                            className="bg-[#000000] text-white rounded-2xl transition-all hover:bg-[#8b6a15] flex items-center justify-center gap-2"
                                        >
                                ...
                                <div className="bg-gray-50 p-5 rounded-lg text-lg font-semibold space-y-2">
                                    ...
                                    <div className="flex justify-between text-xl font-bold text-[#000000] border-t pt-3">
                                        <span>Grand Total:</span>
                            ...
                            <div className="flex justify-between mt-8">
                                ...
                                {currentStep < 2 ? (
                                    <button
                                        ...
                                        className="px-8 py-3 bg-[#000000] text-white rounded-lg hover:bg-[#8b6a15] disabled:opacity-50"
                                    >
                                        Next
                                    </button>
                                ) : (
                                    <button
                                        ...
                                        className="px-8 py-3 bg-[#000000] text-white rounded-lg hover:bg-[#8b6a15] disabled:opacity-50 flex items-center gap-2"
                                    >
