        ...
        <div className="rounded-lg shadow-md p-4">
                ...
                <div className="flex items-center gap-2">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#000000] min-w-[200px]"
                            value={searchTerm}
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-[#000000] hover:bg-[#886817] transition-all text-white rounded-md whitespace-nowrap"
                    >
            ...
            <div className="mt-6 mb-3 flex justify-center items-center gap-2 flex-wrap">
                <button
                    ...
                    className="px-3 py-1 bg-[#000000] text-white rounded-md disabled:opacity-50 whitespace-nowrap"
                >
                    Previous
                </button>
                {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                    <button
                        ...
                        disabled={isLoading}
                        className={`px-3 py-1 mx-1 rounded-md ${currentPage === page ? 'bg-[#000000] text-white' : 'bg-gray-200 text-gray-700'} ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
                        {page}
                    </button>
                ))}
