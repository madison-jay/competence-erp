        ...
        <div className="fixed inset-0 bg-[#000000aa] flex items-center justify-center z-50">
            <div className="bg-white max-h-[90vh] overflow-y-auto rounded-lg shadow-lg p-6 w-full max-w-md">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-lg font-bold text-[#000000]">Add New Customer</h2>
                    <button onClick={onClose} disabled={isLoading}>
                        <FontAwesomeIcon icon={faTimes} className={`text-gray-600 hover:text-[#000000] ${isLoading ? 'opacity-50' : ''}`} />
                    </button>
                </div>
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#000000]"
                            required
                            disabled={isLoading}
                        />
                    </div>
                    ...
                    <div className="flex justify-end gap-2">
                        ...
                        <button
                            type="submit"
                            className={`px-4 py-2 bg-[#000000] text-white rounded-md hover:bg-[#886817] ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                            disabled={isLoading}
                        >
                            {isLoading ? (
