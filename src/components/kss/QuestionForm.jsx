    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <textarea
          ...
          className="w-full px-3 py-2 border border-gray-300 shadow-sm mt-2 rounded-md focus:ring-2 focus:ring-[#000000] outline-none "
          rows={3}
          required
        />
      </div>
            ...
            {Object.entries(options).map(([key, value]) => (
              <div key={key} className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="flex-1 w-full px-3 py-2 border border-gray-300 shadow-sm mt-2 rounded-md focus:ring-2 focus:ring-[#000000] outline-none"
                  required
                />
              </div>
            ))}
