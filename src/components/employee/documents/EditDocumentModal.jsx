            ...
            <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-md">
                <div className="flex justify-between items-center mb-6 border-b pb-3">
                    ...
                    <button
                        ...
                        className="text-gray-500 hover:text-[#000000] transition-colors p-2 disabled:opacity-50"
                        aria-label="Close"
                    >
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        <input
                            type="text"
                            name="name"
                            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#000000] focus:border-[#000000] transition disabled:bg-gray-50 disabled:opacity-70"
                            value={formData.name}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <select
                                name="category"
                                className="w-full p-3 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-[#000000] focus:border-[#000000] transition disabled:bg-gray-50 disabled:opacity-70"
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t">
                        ...
                        <button
                            type="submit"
                            className="px-5 py-2 bg-[#000000] text-white rounded-lg hover:bg-[#8d6b14] transition-colors disabled:opacity-50 font-medium flex items-center justify-center shadow-md shadow-[#000000]/30"
                            disabled={isSubmitting}
                        >
                            {isSubmitting ? (
                                <>
