        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <div className="flex items-center gap-4">
              <label className="inline-flex items-center">
                <input
                  type="radio"
                  className="form-radio text-[#000000] focus:ring-[#000000]"
                  name="uploadMode"
                  value="me"
          ...
          {uploadMode === 'others' && (
            <div className="mb-4 relative" ref={dropdownRef}>
              ...
              <div
                className="w-full p-2 border rounded border-gray-400 focus:ring-[#000000] focus:border-[#000000] focus:outline-none cursor-pointer"
          ...
          <div className="mb-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <button
                ...
                className="text-sm text-[#000000] hover:text-[#8d6b14] font-medium disabled:opacity-50"
                disabled={isSubmitting}
              >
            ...
            {documents.map((doc, index) => (
              <div key={index} className="mb-4 p-4 border border-gray-300 rounded-lg relative">
                ...
                <div className="mb-3">
                  ...
                  <input
                    type="text"
                    className="w-full p-2 border rounded border-gray-400 focus:ring-[#000000] focus:border-[#000000] focus:outline-none disabled:opacity-50"
                    value={doc.name}
...
  hover:file:bg-[#8d6b14] disabled:opacity-50"
          ...
          <div className="flex justify-end gap-2">
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-[#000000] text-white rounded hover:bg-[#8d6b14] transition-colors disabled:opacity-50"
              disabled={isSubmitting}
            >
              {isSubmitting ? (
