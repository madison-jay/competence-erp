                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#000000] focus:border-[#000000] outline-none transition-all ${validationErrors.leaveType ? 'border-red-500' : 'border-gray-300'}`}
                            >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                min={today}
                                className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#000000] focus:border-[#000000] outline-none transition-all ${validationErrors.startDate ? 'border-red-500' : 'border-gray-300'}`}
                                required
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                min={startDate || today}
                                className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#000000] focus:border-[#000000] outline-none transition-all ${validationErrors.endDate ? 'border-red-500' : 'border-gray-300'}`}
                                required
                            />
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#000000] focus:border-[#000000] outline-none resize-none transition-all ${validationErrors.reason ? 'border-red-500' : 'border-gray-300'}`}
                                required
                            />
                        ...
                        <div className="flex gap-4 pt-6">
                            ...
                            <button
                                type="submit"
                                disabled={isSubmitting}
                                className="flex-1 py-3 px-6 bg-[#000000] hover:bg-[#a07815] text-white font-medium rounded-lg transition-all disabled:opacity-60 disabled:cursor-not-allowed shadow-lg"
                            >
