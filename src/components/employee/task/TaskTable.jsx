                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        {task.status === 'Completed' || task.status === 'Cancelled' ? (
                          ...
                          <button 
                            ...
                            disabled={isUpdating}
                            className="px-3 py-1 text-sm font-medium text-white bg-[#000000] rounded-md hover:bg-[#a67c15] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                          >
          ...
          <div className="mt-8 flex justify-end space-x-3">
            ...
            {currentStatus !== 'Completed' && currentStatus !== 'Cancelled' && (
              <button
                ...
                disabled={isUpdating}
                className="px-6 py-2 text-sm font-medium text-white bg-[#000000] rounded-md hover:bg-[#a67c15] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
