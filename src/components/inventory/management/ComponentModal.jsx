                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                className="block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-[#000000] focus:border-[#000000] transition duration-200 file:bg-[#000000] file:p-3 file:text-white file:mr-4" 
                                disabled={saving || uploading}
                            />
