                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                        ...
                        {isProcessing ? (
                            ...
                            <div className="relative mt-1">
                                <input
                                    ...
                                    className="block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#000000]"
                    ...
                    <div>
                        ...
                        {isProcessing ? (
                            ...
                            <input
                                ...
                                className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#000000]"
                    ...
                    <div className="flex justify-end space-x-3 pt-4">
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-[#000000] text-white rounded-md transition-all hover:bg-[#000000] disabled:opacity-50"
                        >
