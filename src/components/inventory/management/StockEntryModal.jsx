                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#000000]"
                        >
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <button
                            ...
                            className="px-6 py-2.5 bg-[#000000] text-white rounded-xl font-medium hover:bg-[#9a7516] disabled:opacity-50 transition-all shadow-sm hover:shadow-md"
                        >
