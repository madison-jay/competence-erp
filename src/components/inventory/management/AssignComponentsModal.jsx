                                ...
                                components.map(component => (
                                    <div key={component.component_id} className="flex items-center space-x-4 p-2 border-b border-gray-200">
                                        <input
                                            ...
                                            className="h-5 w-5 text-[#000000] focus:ring-[#000000] border-gray-300 rounded"
                                            disabled={saving}
                                        />
                                        ...
                                        {selectedComponents[component.component_id]?.selected && (
                                            <input
                                                ...
                                                className="w-24 px-2 py-1 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#000000] focus:border-[#000000]"
                                                min="0"
                                                disabled={saving}
                                            />
                                        )}
