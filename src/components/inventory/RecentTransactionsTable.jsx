                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div className="relative w-full sm:w-72">
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#000000] focus:border-transparent transition"
                        />
                                ...
                                <tr key={idx} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-5">
                                        <button
                                            ...
                                            className="text-[#000000] hover:text-[#9a7516] transition-colors"
                                            title="View Details"
                                        >
                ...
                <div className="fixed inset-0 bg-[#000000aa] bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
                                ...
                                <div className="space-y-3">
                                    {selectedTransaction.items.map((item, i) => (
                                        <div key={i} className="flex justify-between items-center bg-gray-50 px-5 py-4 rounded-xl">
                                            ...
                                            <span className="text-lg font-bold text-[#000000]">×{item.quantity}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                        ...
                        <div className="p-6 border-t border-gray-200">
                            <button
                                onClick={() => setSelectedTransaction(null)}
                                className="w-full py-3 bg-[#000000] text-white font-semibold rounded-lg hover:bg-[#9a7516] transition"
                            >
                                Close
                            </button>
                        </div>
