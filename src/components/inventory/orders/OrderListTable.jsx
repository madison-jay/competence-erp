      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4 mb-5">
        ...
        <div className="relative max-w-xs w-full">
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#000000] focus:border-transparent"
            disabled={isLoading}
          />
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                ...
                {selectedOrder.status === 'shipped' && (
                  <button
                    ...
                    disabled={updating}
                    className="px-6 py-2.5 bg-[#000000] text-white rounded-lg text-sm font-medium hover:bg-[#9a7516] disabled:opacity-70 transition-colors flex items-center gap-2 shadow-sm"
                  >
                    {updating ? (
                      <>Updating...</>
                    ) : (
