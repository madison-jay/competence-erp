        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full p-2 border rounded focus:ring-2 focus:outline-none ${errors.name
                  ...
                  : 'border-gray-400 focus:ring-[#000000] focus:border-[#000000]'
                }`}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full p-2 border rounded border-gray-400 focus:ring-[#000000] focus:border-[#000000] focus:ring-2 focus:outline-none"
