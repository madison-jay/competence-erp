            ...
            <div className="p-6 border-b border-gray-200 flex justify-between items-center">
                <div className="flex items-center gap-3">
                    <div className="p-3 bg-amber-100 rounded-xl">
                        <FontAwesomeIcon icon={faBoxOpen} className="w-6 h-6 text-[#000000]" />
                    </div>
                    <div>
                ...
                <button
                    ...
                    className="text-sm font-medium text-[#000000] hover:text-[#8a6d15] transition-colors underline-offset-2 hover:underline"
                >
                    See all →
                </button>
            </div>
                        ...
                        {orders.map((order) => (
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 bg-gradient-to-br from-[#000000] to-[#9a7516] rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-md">
                                ...
                                <button
                                    ...
                                    className="px-5 py-2.5 bg-[#000000] text-white font-medium rounded-lg hover:bg-[#9a7516] transition-all transform hover:scale-105 shadow-md group-hover:shadow-lg"
                                >
                                    Process
                                </button>
                            </div>
